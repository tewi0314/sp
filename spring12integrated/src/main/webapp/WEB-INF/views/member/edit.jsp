...
<!-- (주의) table 부터 th/td 사이에는 어떠한 태그도 적을 수 없다 -->
...
<table border="0" width="400">
	<tbody>
		...
		<tr>
			<th>생년원일</th>
			<td>
				<input type="date" name="memberBirth" required valyue="${memberDto.memberBirth}">
			</td>
		</tr>
		<tr>
			<th>이메일</th>
		...
		<tr>
			<td>
				<input type="text" name="memberBasicAddr" value="${memberDto.meberBasicAddr}" placeholder="기본주소">
			</td>
		</tr>
		<tr>
			<td>
					<input type="text" name="memberDetailAddr" value="${memberDto.meberDetailAddr}" placeholder="상세주소">
